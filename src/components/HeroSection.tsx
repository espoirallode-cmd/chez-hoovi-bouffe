  ...
  return (
    ...
    >
      ...
      <img 
        ...
        className="absolute pointer-events-none w-[60px] h-[60px] md:w-[240px] md:h-[240px] top-[60%] md:top-[calc(55%+25px)] left-[52%] md:left-[calc(50%+50px)] transform -translate-x-1/2 -translate-y-1/2"
        style={{
          zIndex: 40
        }}
      />
