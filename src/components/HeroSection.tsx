...
const HeroSection = () => {
  return (
    <section 
      id="accueil" 
      className="relative min-h-[450px] md:min-h-[calc(100vh-100px)] flex items-center pt-24 md:pt-0 overflow-hidden px-[12px] py-[10px] md:px-0 md:py-0 hero-dot-pattern"
    >
